...
<div <?php print drupal_attributes($page['attributes_array']['page']); ?>>
     <div class="header" <?php print drupal_attributes($page['attributes_array']['header']); ?> style="border:none">
...
?>
    ...
    <div class="front main-content" style="overflow: hidden;" <?php print drupal_attributes($page['attributes_array']['content']); ?>>

        <h4 class="text blank small"> FIND PRODUCTS BY:</h4>
            <ul data-role="listview" style="margin: 0px;" >
                <li class="orange padb"><a href="/list/2">CATALOG</a></li>
                <li class="blue padb"><a href="/list/3">EVENT TYPE</a></li>
                <li class="pink padb"><a href="/list/4">AGE GROUP</a></li>
            </ul>
        
       <?php 
        if ( $block = module_invoke('views', 'block_view', "-exp-mobile_search-page") ) {
